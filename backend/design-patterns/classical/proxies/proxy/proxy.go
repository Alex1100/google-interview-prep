 ...
 * Proxy Pattern
 *
 * Provides interesting features and possibilities
 * with very little effort
 *
 * Wraps an object to hide some of it's characteristics
 *
 * Variants
 * Remote Proxy
 * Virtual Proxy
 * Protection Proxy (Restricted Access Proxy)
 *
 *
 *
 */
...
func (u *UserListProxy) FindUser(id int32) (User, error) {
  ...
  fmt.Println("Returning user from the database")
